...
{
  new (message_memory) my_interface::msg::Example(_init);
}

void Example_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_interface::msg::Example *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Example_message_member_array[2] = {
  {
    ...
    offsetof(my_interface::msg::Example, data1),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_interface::msg::Example, data2),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Example_message_members = {
  ...
  2,  // number of fields
  sizeof(my_interface::msg::Example),
...
get_message_type_support_handle<my_interface::msg::Example>()
{
  return &::my_interface::msg::rosidl_typesupport_introspection_cpp::Example_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_interface, msg, Example)() {
  return &::my_interface::msg::rosidl_typesupport_introspection_cpp::Example_message_type_support_handle;
}
