...
#include "my_interface/msg/detail/example__rosidl_typesupport_fastrtps_c.h"
...
using _Example__ros_msg_type = my_interface__msg__Example;
...
size_t get_serialized_size_my_interface__msg__Example(
  const void * untyped_ros_message,
...
static uint32_t _Example__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_interface__msg__Example(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_interface
size_t max_serialized_size_my_interface__msg__Example(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_interface__msg__Example;
    is_plain =
      (
      offsetof(DataType, data2) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Example__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_interface__msg__Example(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_interface, msg, Example)() {
