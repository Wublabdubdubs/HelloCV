...
#include "my_interface/msg/detail/example__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_interface::msg::Example & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_interface::msg::Example & ros_message)
{
  // Member: data1
  cdr >> ros_message.data1;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_interface::msg::Example;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_interface::msg::Example *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_interface::msg::Example *>(
    untyped_ros_message);
...
{
  return &my_interface::msg::typesupport_fastrtps_cpp::_Example__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interface, msg, Example)() {
  return &my_interface::msg::typesupport_fastrtps_cpp::_Example__handle;
}
